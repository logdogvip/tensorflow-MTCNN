...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_mode', type=str, default="image")
    parser.add_argument('--test_mode', type=str, default="RNet", )
    ...
    if args.test_mode in ["RNet", "ONet"]:
        RNet = Detector(R_Net, 24, 256, model_path[1])
        detectors[1] = RNet
    ...
    mtcnn_detector = MtcnnDetector(detectors=detectors, min_face_size=args.min_face_size,
